    ...
    getSession: async (targetDomain = null) => {
        return new Promise((resolve, reject) => {
            ...
            chrome.cookies.getAll(query, (cookies) => {
                console.log("DEBUG: All 'sid' cookies found:", cookies.map(c => c.domain));
                ...
                let sfCookie;
                if (targetDomain) {
                    console.log(`DEBUG: Target Domain: ${targetDomain}`);
                    ...
                    if (!sfCookie) {
                        ...
                        console.log(`DEBUG: Extracted Org ID: ${orgId}`);
                ...
                if (sfCookie) console.log(`DEBUG: Matched Cookie Domain: ${sfCookie.domain}`);
